...
enum HorizontalDefaultTheme {
    ...
    private static let fixedLayerColors: [Int: Color] = [
        ...
        HorizontalBoardLayers.topMask: color(red: 1, green: 0.5, blue: 0.5),
        ...
        HorizontalBoardLayers.bottomMask: color(red: 0.25, green: 0.5, blue: 0.25),
    ...
    private static let fixedLayerNSColors: [Int: HorizontalPlatformColor] = [
        ...
        HorizontalBoardLayers.topMask: platformColor(red: 1, green: 0.5, blue: 0.5),
        ...
        HorizontalBoardLayers.bottomMask: platformColor(red: 0.25, green: 0.5, blue: 0.25),
